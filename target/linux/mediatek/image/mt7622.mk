...
define Device/dlink_dir-x3260-a1-ubi
  DEVICE_VENDOR := D-Link
  DEVICE_MODEL := DIR-X3260 A1
  DEVICE_VARIANT := UBI
...
# recovery can also be used with stock firmware web-ui, hence the padding...
  ...
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := bl2 snand-1ddr
  ARTIFACT/bl31-uboot.fip := bl31-uboot dlink_dir-x3260-a1
endef
TARGET_DEVICES += dlink_dir-x3260-a1-ubi
